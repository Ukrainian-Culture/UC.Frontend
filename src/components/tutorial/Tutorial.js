        ...
        steps: [
            {
                title: "Map",
                target: '.mapSection',
                content: 'It a map, you can click on region and see: history of region and famous articles'
            },
            {
                title: "Statistics",
            ...
            },
            {
                title: "End",
                target: '.mapSection',
                content: 'Also we have a "explore" menu and posibillity to change language, but find this is challenge to you <3'
            }
        ]
    };
